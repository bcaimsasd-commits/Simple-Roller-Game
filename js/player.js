...
var Player = {  
  ...
  lives: 3,        // how many hits we can take before the level restarts  
  hitState: "normal", // "normal" or "invincible"  
  hitTimer: 0      // frames of invincibility left  
};  
...
// Take one hit, but only if we are not already flashing.  
...
// Is the player out of the game? Spikes and enemies cost a life;  
// falling off the world still ends everything instantly.  
